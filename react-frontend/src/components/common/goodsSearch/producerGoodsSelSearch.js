...
import {getAllGoodsSaleList, getAllGoodsNotEvent} from "~/lib/producerApi";
...
class ProducerGoodsSelSearch extends Component{
    constructor(props){
        super(props);
        this.state = {
...
ProducerGoodsSelSearch.propTypes = {
}
ProducerGoodsSelSearch.defaultProps = {
}
export default ProducerGoodsSelSearch
