...
class B2cGoodsSearch extends Component{
    ...
    onSearch = () => {
        ...
        const v_searchType = this.state.searchType;
        const v_searchKeyword = this.state.searchKeyword;
    ...
    goodsSearchAPIcall = async () => {
        ...
        if(v_goodsSearchType === "all") {
            parmas = {goodsState:"1",searchType:v_searchType,searchKeyword:v_searchKeyword};
        }
