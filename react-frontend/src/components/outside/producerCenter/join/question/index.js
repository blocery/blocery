...
import { Container, Row, Col, Card, CardTitle, CardText, Input, Label } from 'reactstrap'
                        ...
                        <Col className='p-0'>
                            ...
                            <Col sm={12} className='mb-3'>
                                <Card body>
                                    ...
                                    <CardText>
                                        수집목적 : 온라인 쇼핑몰 입점문의<br/>
                                        수집 항목 : 담당자명, 담당자 연락처, 담당자 이메일<br/>
                                        보유기간 : 문의 완료 후 90일 이내 개인정보 수집/이용 동의해주셔야 입점문의 처리가 가능합니다. <br/>
                                        <Label check style={{marginTop: 16}}>
                            ...
                            <Col className='mb-3'>
                                <Button bg='green' fg={'white'} noHover block py={16} fontSize={20} onClick={this.onClickSubmit}>제출</Button>
                            </Col>
                        </Col>
                    </Row>
