...
const MdPickSub = (props) => {
    ...
    async function search(){
        const {data} = await getMdPick(id, isForceUpdate(props.history), abortControllerRef.current.signal)
...
export default withRouter(MdPickSub)
