...
const Content = ({goods}) => {
    const {goodsNm, defaultDiscountRate, eventOptionPrice, eventOptionName, defaultCurrentPrice, consumerPrice, superRewardReward, superRewardStart, superRewardEnd} = goods
    return(
        <ContentContainer>
