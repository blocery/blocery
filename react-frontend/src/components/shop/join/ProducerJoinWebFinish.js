                ...
                <Row>
                    <Col className='p-0'>
                        <div className='m-4'>
                            ...
                            <p className='text-dark lead'>샵블리(ShopBly) 판매자(생산자) 회원가입 및 입점 계약 체결이 완료 되었습니다.<br/>
                                판매자에게 도움이 되는 샵블리가 될 수 있도록 최선의 노력을 다하겠습니다.</p>
                        </div>
                        <hr/>
                        <div className='m-4'>
                            ...
                            <p>궁금한 사항은 샵블리(ShopBly) 고객센터 또는 메일로 문의 부탁 드립니다.<br/>
