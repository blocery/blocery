            ...
            >
                ...
                >
                    ...
                    <div>
                        ...
                        <Div fontSize={12} fg={'adjust'} lineHeight={14}> {order.optionName?'옵션명:' + order.optionName:''} 구매수량 : {ComUtil.addCommas(order.orderCnt)}건</Div>
                        {
                            //공동구매 커맨트: !order.directGoods && <Div fontSize={12} fg={'danger'}>예약상품(묶음배송불가)</Div>
                            order.dealGoods && <Div fontSize={12} fg={'danger'}>공동구매 상품</Div>
                        }
                    </div>
                </Flex>
                <Div>
